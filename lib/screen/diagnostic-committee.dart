...
class DiagnosticCommittee extends StatefulWidget {
  static String id='diagnostic_committee';

  @override
  State<DiagnosticCommittee> createState() => _DiagnosticCommitteeState();
}

class _DiagnosticCommitteeState extends State<DiagnosticCommittee> {
  ...
  Future<List<ListOfCommitteeApi>> getPostApi() async{
    postList = [];
    final response = await http.get(Uri.parse('https://morehost.co.in/app/native_app/diagnostic-committee.php'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('DIAGNOSTIC COMMITTEE', style: TextStyle(color: Colors.white),),
        actions: [
          CommotteeMenu()
        ],
