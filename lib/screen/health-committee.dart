...
class HealthCommittee extends StatefulWidget {
  static String id='health_committee';

  @override
  State<HealthCommittee> createState() => _HealthCommitteeState();
}

class _HealthCommitteeState extends State<HealthCommittee> {
  ...
  Future<List<ListOfCommitteeApi>> getPostApi() async{
    postList = [];
    final response = await http.get(Uri.parse('https://morehost.co.in/app/native_app/health-committee.php'));
