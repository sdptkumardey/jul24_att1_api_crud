...
import 'package:jul24_att1_api_crud/screen/member_details.dart';
class ListOfCommittee extends StatefulWidget {
  static String id='list_of_committee';

  @override
  State<ListOfCommittee> createState() => _ListOfCommitteeState();
}

class _ListOfCommitteeState extends State<ListOfCommittee> {
  ...
  Future<List<ListOfCommitteeApi>> getPostApi() async{
    postList = [];
    final response = await http.get(Uri.parse('https://morehost.co.in/app/native_app/list-of-committee.php'));
    ...
    return Scaffold(
      backgroundColor: Color(0XFFc6cedf),
        appBar: AppBar(
          ...
          title: Text('List Of Committee', style: TextStyle(color: Colors.white),),
          actions: [
CommotteeMenu()
          ],
