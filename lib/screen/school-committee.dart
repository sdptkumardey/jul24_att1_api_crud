...
class SchoolCommittee extends StatefulWidget {
  static String id='school_committee';
  @override
  State<SchoolCommittee> createState() => _SchoolCommitteeState();
}

class _SchoolCommitteeState extends State<SchoolCommittee> {
  ...
  Future<List<ListOfCommitteeApi>> getPostApi() async{
    postList = [];
    final response = await http.get(Uri.parse('https://morehost.co.in/app/native_app/school-committee.php'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('School Committee', style: TextStyle(color: Colors.white),),
        actions: [
          CommotteeMenu()
        ],
