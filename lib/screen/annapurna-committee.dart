...
class AnnapurnaCommittee extends StatefulWidget {
  static String id='annapurna_committee';

  @override
  State<AnnapurnaCommittee> createState() => _AnnapurnaCommitteeState();
}

class _AnnapurnaCommitteeState extends State<AnnapurnaCommittee> {
  ...
  Future<List<ListOfCommitteeApi>> getPostApi() async{
    postList = [];
    final response = await http.get(Uri.parse('https://morehost.co.in/app/native_app/annapurna-committee.php'));
