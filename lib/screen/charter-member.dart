...
import 'package:jul24_att1_api_crud/screen/member_details.dart';
class CharterMember extends StatefulWidget {
  static String id='charter_member';
  @override
  State<CharterMember> createState() => _CharterMemberState();
}

class _CharterMemberState extends State<CharterMember> {
  ...
  Future<List<ListOfCommitteeApi>> getPostApi() async{
    postList = [];
    final response = await http.get(Uri.parse('https://morehost.co.in/app/native_app/charter-member.php'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Charter Member', style: TextStyle(color: Colors.white),),
      ),
      body: Container(
