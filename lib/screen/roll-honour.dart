...
class RollHonour extends StatefulWidget {
  static String id='roll_honour';

  @override
  State<RollHonour> createState() => _RollHonourState();
}

class _RollHonourState extends State<RollHonour> {
  ...
  Future<List<RollHonourApi>> getPostApi() async{
    postList = [];
    final response = await http.get(Uri.parse('https://morehost.co.in/app/native_app/roll_honour.php'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Roll Of Honour', style: TextStyle(color: Colors.white),),
        actions: [
          CommotteeMenu()
        ],
      ),
